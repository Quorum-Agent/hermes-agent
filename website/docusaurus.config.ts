...
const config: Config = {
  title: 'Quorum',
  tagline: 'Fail-closed AI. Your data, your rules.',
  favicon: 'img/favicon.ico',

  url: 'https://quorum.devdads.com', // TODO: confirm Quorum docs domain
  baseUrl: '/docs/',

  organizationName: 'Quorum-Agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Quorum-Agent/hermes-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Quorum-Agent/hermes-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/Quorum-Agent/hermes-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://quorum.devdads.com/' },
            { label: 'GitHub', href: 'https://github.com/Quorum-Agent/hermes-agent' },
            { label: 'Nous Research', href: 'https://nousresearch.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://devdads.com">Dev Dads</a> · Based on Hermes Agent by Nous Research · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
