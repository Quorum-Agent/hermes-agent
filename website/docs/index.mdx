...
description: "Quorum — a fail-closed AI agent with mandatory Private / Balanced / Quality / Offline routing you control. Based on Hermes Agent by Nous Research."
...
A fail-closed AI agent with mandatory **Private / Balanced / Quality / Offline** routing you control — so sensitive work only ever reaches the inference boundary you allow. Based on [Hermes Agent](https://hermes-agent.nousresearch.com) by [Nous Research](https://nousresearch.com).
...
>
  ...
  <a
    ...
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(67,217,163,0.2)",
      borderRadius: "8px",
      textDecoration: "none",
    }}
  >
