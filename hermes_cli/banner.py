...
_UPSTREAM_REPO_URL = SOURCE_REPO_URL
_OFFICIAL_REPO_CANONICAL = SOURCE_REPO_CANONICAL
...
_RELEASE_URL_BASE = RELEASE_URL_BASE
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical Quorum-Agent/hermes-agent repo (forks don't get a link).
    """
