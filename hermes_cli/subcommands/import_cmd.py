...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help=f"Restore a {PRODUCT_NAME} backup from a zip file",
        description=f"Extract a previously created {PRODUCT_NAME} backup into your "
        f"{PRODUCT_NAME} home directory, restoring configuration, skills, "
        "sessions, and data",
    )
