...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Quorum"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Quorum"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Quorum",
            "welcome": "Welcome to Quorum! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
