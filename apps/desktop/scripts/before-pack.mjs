 ...
 */
export function preserveRollbackBackup(appOutDir, productExeName = 'Quorum.exe') {
...
export default async function beforePack(context) {
  ...
  try {
    ...
    // rename fails.
    const productExe = `${(context && context.packager?.appInfo?.productFilename) || 'Quorum'}.exe`
