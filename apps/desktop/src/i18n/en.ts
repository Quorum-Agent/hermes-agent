...
export const en: Translations = {
  ...
  boot: {
    ready: 'Quorum Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Quorum settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Quorum Desktop…'
    },
    errors: {
      backgroundExited: 'Quorum background process exited.',
      backgroundExitedDuringStartup: 'Quorum background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Quorum backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Quorum',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Quorum Desktop.',
    ...
    native: {
      ...
      inputBody: 'Quorum is waiting for your response.',
      turnDoneTitle: 'Quorum finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Quorum defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Quorum is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Quorum asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Quorum was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Quorum follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Quorum can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Quorum is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Quorum, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Quorum checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Quorum configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Quorum.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Quorum backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private Quorum backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Quorum backend.',
      ...
      restartingMessage: 'Quorum Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Quorum ${version}` : ''}`,
      ...
      sshDesc:
        'Quorum is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Quorum path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Quorum found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Quorum runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Quorum is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/Quorum-Agent/hermes-agent/main/scripts/install.sh | sh) or set the Quorum path.',
      sshErrPlatform:
        'Unsupported remote platform. Quorum Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Quorum on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Quorum runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Quorum at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Quorum builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Quorum to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Quorum to generate pets.',
      backgroundHint: 'You can close this — Quorum will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Quorum desktop' },
    ...
    hermesActiveSessions: (version, count) => `Quorum ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Quorum environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Quorum will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Quorum backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Quorum. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Quorum...',
    placeholderReconnecting: 'Reconnecting to Quorum…',
    ...
    attachUrlDesc: 'Quorum will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Quorum to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Quorum…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Quorum…',
    ...
    unsupportedMessage: 'This version of Quorum can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Quorum is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Quorum backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Quorum from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Quorum will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Quorum desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Quorum updater takes over in its own window and reopens Quorum automatically when it’s done. Please don’t reopen Quorum yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Quorum reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Quorum reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Quorum needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Quorum Desktop',
    setupChoiceDesc:
      'Connect this app to a Quorum gateway you already run, or install Quorum locally on this computer.',
    connectExistingTitle: 'Connect to existing Quorum',
    ...
    installLocalTitle: 'Install Quorum locally',
    installLocalDesc: 'Download Quorum, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Quorum Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Quorum',
    remoteSetupDesc: 'Enter your gateway URL. Quorum Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Quorum gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Quorum gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Quorum',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Quorum CLI or desktop instance is running. Stop any running Quorum instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Quorum installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you set up with Quorum",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Quorum is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Quorum…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Quorum',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Quorum at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Quorum connects automatically',
    ...
    authorizeThere: 'Authorize Quorum there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Quorum there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Quorum Desktop v${version}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Quorum will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Quorum is restarting...',
      askRestart: 'Ask Quorum to restart the server',
      lookingRestart: taskId => `Quorum is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Quorum is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Quorum finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Quorum could not restart the server.',
      stillWorking:
        'Quorum is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Quorum is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Quorum gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.quorum/config.yaml). Quorum won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Quorum needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Quorum needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Quorum Desktop to use Save Image.',
    restartToSaveImages: 'Restart Quorum Desktop to save images',
