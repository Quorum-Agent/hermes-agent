 ...
 *
 * A public install can end up with `origin=git@github.com:Quorum-Agent/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = PRODUCT_IDENTITY.sourceRepoHttpsUrl
const OFFICIAL_REPO_CANONICAL = PRODUCT_IDENTITY.sourceRepoCanonical
